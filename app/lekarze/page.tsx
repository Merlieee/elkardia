      ...
      <section className="relative h-[520px] overflow-hidden">
        ...
        <div className="relative flex h-full items-end pb-12">
          <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
            <p className="text-pretty mb-2 text-xs font-semibold uppercase tracking-widest text-[#EE3920]">Nasz zespół</p>
            <h1 className="text-balance text-4xl font-bold text-white sm:text-5xl">Lekarze specjaliści</h1>
