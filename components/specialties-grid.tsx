...
const specialties = [
  { icon: Heart,         label: "Kardiologia dorosłych",        desc: "Diagnostyka i leczenie chorób serca u dorosłych.",                                         href: "/lekarze" },
  { icon: Baby,          label: "Kardiologia dziecięca",         desc: "Specjalistyczna opieka kardiologiczna dla dzieci i młodzieży.",                            href: "/lekarze" },
  { icon: TrendingUp,    label: "Hipertensjologia",              desc: "Diagnostyka i leczenie nadciśnienia tętniczego.",                                          href: "/lekarze" },
  { icon: Scissors,      label: "Kardiochirurgia",               desc: "Konsultacje kardiochirurgiczne i opieka pooperacyjna.",                                    href: "/lekarze" },
  { icon: Wind,          label: "Pulmonologia",                  desc: "Choroby płuc i układu oddechowego.",                                                       href: "/lekarze" },
  { icon: Brain,         label: "Neurologia",                    desc: "Diagnostyka i leczenie chorób układu nerwowego.",                                          href: "/lekarze" },
  { icon: Brain,         label: "Neurochirurgia",                desc: "Konsultacje neurochirurgiczne.",                                                           href: "/lekarze" },
  { icon: GitBranch,     label: "Chirurgia naczyniowa",          desc: "Choroby naczyń krwionośnych i leczenie chirurgiczne.",                                     href: "/lekarze" },
  { icon: FlaskConical,  label: "Endokrynologia",                desc: "Zaburzenia hormonalne i choroby gruczołów wydzielania wewnętrznego.",                      href: "/lekarze" },
  { icon: Droplets,      label: "Diabetologia",                  desc: "Leczenie cukrzycy i zaburzeń metabolicznych.",                                             href: "/lekarze" },
  { icon: Filter,        label: "Nefrologia",                    desc: "Choroby nerek i leczenie nerkozastępcze.",                                                 href: "/lekarze" },
  { icon: Apple,         label: "Dietetyka kliniczna",           desc: "Analiza składu ciała i indywidualny plan żywienia.",                                       href: "/dietetycy" },
  { icon: Activity,      label: "Balneologia",                   desc: "Leczenie uzdrowiskowe i rehabilitacja kardiologiczna.",                                    href: "/lekarze" },
