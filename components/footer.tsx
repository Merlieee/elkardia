          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2">
              <a href="https://www.facebook.com/elkardia.lubelskie.centrum.kardiologii" target="_blank" rel="noopener noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition-colors hover:bg-[#EE3920] hover:text-white">
                <FacebookIcon />
              </a>
              <a href="https://www.instagram.com/elkardia.pl/" target="_blank" rel="noopener noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition-colors hover:bg-[#EE3920] hover:text-white">
                <InstagramIcon />
              </a>
